...
for offset in offsets:
    for step in steps:
        ...
        for frame in range(0,9,1):
            ...
            path = "D:\\Visual Studio Code\\rtrk\\vectors\\vectorsBlock42\\vectorsFrame" +str(frame)+"StepSize"+ str(step)+"Offset"+str(offset)+".bin"
...
wb.save('validationResultBlock42.xls')